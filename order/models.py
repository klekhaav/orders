...
class RatesTable(models.Model):
    ...
    fuel_surcharge = models.CharField(max_length=5, blank=True, null=True)
    surcharge_other_perc = models.CharField(max_length=5, blank=True, null=True)
    surcharge_flat = models.CharField(max_length=5, blank=True, null=True)
    tax_rate = models.FloatField(default=0.1)
    minimum = models.CharField(max_length=5, blank=True, null=True)
    break1_start = models.CharField(max_length=5, blank=True, null=True)
    break1_end = models.CharField(max_length=5, blank=True, null=True)
    basic1 = models.CharField(max_length=5, blank=True, null=True)
    kilo1 = models.CharField(max_length=5, blank=True, null=True)
    break2_start = models.CharField(max_length=5, blank=True, null=True)
    break2_end = models.CharField(max_length=5, blank=True, null=True)
    basic2 = models.CharField(max_length=5, blank=True, null=True)
    kilo2 = models.CharField(max_length=5, blank=True, null=True)
    break3_start = models.CharField(max_length=5, blank=True, null=True)
    break3_end = models.CharField(max_length=5, blank=True, null=True)
    basic3 = models.CharField(max_length=5, blank=True, null=True)
    kilo3 = models.CharField(max_length=5, blank=True, null=True)
    break4_start = models.CharField(max_length=5, blank=True, null=True)
    break4_end = models.CharField(max_length=5, blank=True, null=True)
    basic4 = models.CharField(max_length=5, blank=True, null=True)
    kilo4 = models.CharField(max_length=5, blank=True, null=True)
    break5_start = models.CharField(max_length=5, blank=True, null=True)
    break5_end = models.CharField(max_length=5, blank=True, null=True)
    basic5 = models.CharField(max_length=5, blank=True, null=True)
    kilo5 = models.CharField(max_length=5, blank=True, null=True)
